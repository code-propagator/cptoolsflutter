...
// ### 認証を行わず、４桁パスコードのみを入力するための画面

class InputLockScreen extends StatefulWidget {
  ...
  @override
  _InputLockScreenState createState() => _InputLockScreenState();
}

class _InputLockScreenState extends State<InputLockScreen> {
